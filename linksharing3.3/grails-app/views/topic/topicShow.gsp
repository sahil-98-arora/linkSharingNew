...
<div style="margin-left: 50px; margin-top: 20px;">
    <div style="float: left; width: 450px; margin-right: 20px; ">
                ...
                <div class="card-body">
                    ...
                    <div class="postContent">
                        <p>
                            ...
                            <span style="color: gray;">@${topic.users.userName}</span><a href="#" style="float: inline-end;">Subscribe/Unsubscriibe</a>
                            <br>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">Users : "<span style="font-weight: 700; font-size: 20px">${topic.topicName}</span>"
...
%{--                        <img class="pImage" src="missing-image.jpg" onerror="this.src='default-image.jpg';" alt="Missing Image" />--}%
                    ...
                    <div class="postContent">
                        <p>
                            <a href="#" style="font-size: 30px;"> NAME </a><br>
