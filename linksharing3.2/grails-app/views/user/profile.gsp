...
<g:else>
    ...
    <div style="margin-left: 50px; margin-top: 20px;">
        ...
        <g:if test="${flash.message}">
            <div style="text-align: center"><span class="message" style="display: block; color: limegreen; margin-left: 140px; font-weight: 800">${flash.message}</span></div>
        </g:if>
        <g:if test="${flash.error}">
            <div style="text-align: center"><span class="alert alert-error" style="display: block; color: red; margin-left: 140px; font-weight: 800">${flash.error}</span></div>
        </g:if>
            <div class="card">
...
%{--                    <form>--}%
                    <g:form controller="User" action="updateDetails" method="POST" update="allTheMessages" name="updateDetails">
