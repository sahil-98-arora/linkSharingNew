...
%{--            <g:if test="${flash.messageLoginError}">--}%
%{--                <div style="text-align: center"><span class="alert alert-error" style="display: block; color: red; font-weight: 800">${flash.messageLoginError}</span></div>--}%
%{--            </g:if>--}%
            <g:if test="${flash.messageSignupFailed}">
                <div style="text-align: center"><span class="alert alert-error" style="display: block; color: red; font-weight: 800">${flash.messageSignupFailed}</span></div>
            </g:if>
                                            ...
                                            <div class="center-wrap">
                                                <div class="section text-center">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" name="userName" class="form-style" placeholder="Your Username" id="userName" autocomplete="off" value="${user?.userName}" required>
                                                        <i class="input-icon uil uil-user-circle"></i>
                                                    </div>
                                                    <div class="form-group mt-2">
                                                        <input type="password" name="password" class="form-style" placeholder="Your Password" id="password" autocomplete="off" value="${user?.password}" required>
                                                    ...
                                                    <g:if test="${flash.messageUserNotFound}">
                                                        <div style="text-align: center"><span class="message" style="display: block; color: red; font-weight: 800">${flash.messageUserNotFound}</span></div>
                                                    </g:if>
                                                    <g:if test="${flash.messageWrongOtp}">
                                                        <div style="text-align: center"><span class="message" style="display: block; color: red; font-weight: 800">${flash.messageWrongOtp}</span></div>
                                                    </g:if>
                                                    <g:if test="${flash.messagePasswordNotChanged}">
                                                        <div style="text-align: center"><span class="message" style="display: block; color: red; font-weight: 800">${flash.messagePasswordNotChanged}</span></div>
                                                    </g:if>
                                                    <g:if test="${flash.messagePasswordChanged}">
                                                        <div style="text-align: center"><span class="message" style="display: block; color: limegreen; font-weight: 800">${flash.messagePasswordChanged}</span></div>
                                                    </g:if>
                                            ...
                                            <div class="center-wrap">
                                                <div class="section text-center" style="margin-top: 250px;">
                                                    ...
                                                    <g:form controller="User" action="signup" method="POST" enctype="multipart/form-data">
                                                        <div class="form-group">
                                                            <input type="text" name="firstName" class="form-style" placeholder="Your First Name" id="firstName" autocomplete="off" required>
                                                            <i class="input-icon uil uil-user"></i>
                                                        </div>
                                                        <div class="form-group">
                                                            <input type="text" name="lastName" class="form-style" placeholder="Your Last Name" id="lastName" autocomplete="off" required>
                                                            <i class="input-icon uil uil-user"></i>
                                                        </div>
                                                        <div class="form-group mt-2">
                                                            <input type="email" name="email" class="form-style" placeholder="Your Email" id="email" autocomplete="off" required>
                                                        ...
                                                        <div class="form-group mt-2">
                                                            <input type="password" name="confirmPassword" class="form-style" placeholder="Confirm Password" id="confirmPassword" autocomplete="off" required>
                                                            <i class="input-icon uil uil-lock-alt"></i>
                                                        </div>
                                                        <div class="form-group mt-2">
