            ...
            <p style="float: inline-end; margin-bottom: 0%;">
                ...
                &nbsp;&nbsp;
                    ...
                    <g:if test="${num.users.id == session.user.id}">
                        ...
                        <i id="deleteTopic" class="far fa-trash-alt fa-2x" style="margin-left: 20px" onclick="deleteTopic(${num.id})"></i>
                    </g:if>
                    <g:else>
                        <i class="far fa-envelope fa-2x" style="margin-left: 20px"></i>&nbsp;&nbsp;
                    </g:else>
...
<script>
    ...
    function deleteTopic(id){
        $.ajax({
            type: 'post',
            url: "http://localhost:8091/topic/userProfileTopicsCreated",
            data: {"topId" : id}, //$("#topicName").val() },
            success: function (){
                $(".card" + id).hide('slow');
                //alert("working");
            }
