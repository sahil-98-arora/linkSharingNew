            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <g:form controller="user" action="sendInvitation">
...
%{--                                </select>--}%
                                ...
                                <g:actionSubmit value="share" class="btn btn-primary" style="float: left;" name="sendInvitation" controller="user" action="sendInvitation"/>
                            </g:form>
                    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <g:form controller="resource" action="addDocumentResource" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="file" class="form-control" id="document"  name="filePath" required>
                            <br>
                            <label for="description">Description</label>
                            <textarea rows="2" cols="45" id="description" name="description" placeholder="Enter description here" required></textarea>
                            <br><br>
                            <label> Topic:  </label>
%{--                            <select>--}%
%{--                                <option value = "topicid"> topic </option>--}%
...
%{--                            <g:select name="topicName" from="${linksharing3.Topic.list().topicName}" class="dropdown-toggle btn btn-default col-sm-8" value="${addedResource?.topicName}"></g:select>--}%
        ...
        <g:if test="${flash.messageTopicCreatedSuccess}">
            <div style="text-align: center"><span class="message" style="display: block; color: limegreen; margin-left: 10px; font-weight: 800; margin-bottom: 10px">${flash.messageTopicCreatedSuccess}</span></div>
        </g:if>
        <g:if test="${flash.messageTopicCreationFails}">
            <div style="text-align: center"><span class="message" style="display: block; color: limegreen; font-weight: 800; margin-bottom: 20px">${flash.messageTopicCreationFails}</span></div>
        </g:if>
        <g:if test="${flash.messageResourceAdded}">
            <div style="text-align: center"><span class="message" style="display: block; color: limegreen; font-weight: 800; margin-bottom: 20px">${flash.messageResourceAdded}</span></div>
        </g:if>
        <g:if test="${flash.messageResourceNotAdded}">
            <div style="text-align: center"><span class="message" style="display: block; color: red; font-weight: 800; margin-bottom: 20px">${flash.messageResourceNotAdded}</span></div>
        </g:if>
        <g:if test="${flash.messageDocResourceAdded}">
            <div style="text-align: center"><span class="message" style="display: block; color: limegreen; font-weight: 800; margin-bottom: 20px">${flash.messageDocResourceAdded}</span></div>
        </g:if>
        <g:if test="${flash.messageDocResourceNotAdded}">
            <div style="text-align: center"><span class="message" style="display: block; color: red; font-weight: 800; margin-bottom: 20px">${flash.messageDocResourceNotAdded}</span></div>
        </g:if>
        <g:if test="${flash.messageInviteSentSuccess}">
            <div style="text-align: center"><span class="message" style="display: block; color: limegreen; font-weight: 800; margin-bottom: 20px">${flash.messageInviteSentSuccess}</span></div>
        </g:if>
