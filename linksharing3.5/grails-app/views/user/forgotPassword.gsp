...
<g:form  controller="user" action="otpVerify">
    <g:if test="${flash.messageEmailSent}">
        <div style="text-align: center"><span class="message" style="display: block; color: limegreen; font-weight: 800">${flash.messageEmailSent}</span></div>
    </g:if>
    <h1>${user.email}</h1>
    <div class="icon">
