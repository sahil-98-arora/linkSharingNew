...
<g:form controller="resource" action="addLinkResource" method="POST">
    ...
    <input type="text" class="form-control" id="url" placeholder="Enter Link" name="url" required>
    <br>
    <label for="description">Description</label>
    <textarea rows="2" cols="45" name="description" id="description" placeholder="Enter description here" required></textarea>
    <br><br>
